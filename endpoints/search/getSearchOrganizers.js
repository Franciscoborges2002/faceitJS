...
/*
    ...
    Description: 
*/
module.exports = async function getSearchOrganizers(organizerName, offset = 0,limit = 20) {
  ...
  //get url
  let url = urlConstructorUtil(baseURL, ['organizers'], [''], ['name'], [organizerName], searchOptions);
