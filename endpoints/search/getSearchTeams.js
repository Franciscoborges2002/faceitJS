...
/*
    ...
    Description: 
*/
module.exports = async function getSearchTeams(playerName, game = '' , offset = 0,limit = 20) {
  ...
  //get url
  let url = urlConstructorUtil(baseURL, ['teams'], [''], ['nickname', 'game'], [playerName, game], searchOptions);
